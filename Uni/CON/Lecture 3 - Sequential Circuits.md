...
- Q = 1
- Set E = 0 -> Q stays at 1 ([[Lecture 3 - Sequential Circuits#Default Configuration (`E = 0`)| in the default config again]])

#### Resetting the output (S = 0, R = 1, E = 1)
- Q = 0
- Set E = 0 -> Q stays at 0 ([[Lecture 3 - Sequential Circuits#Default Configuration (`E = 0`)| in the default config again]])
